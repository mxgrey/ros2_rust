...
impl Default for CancelGoal_Request {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::vendor::action_msgs::srv::rmw::CancelGoal_Request::default())
  }
}
...
impl Default for CancelGoal_Response {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::vendor::action_msgs::srv::rmw::CancelGoal_Response::default())
  }
}
    ...
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        ...
        goals_canceling: msg.goals_canceling
          .into_iter()
          .map(|elem| crate::vendor::action_msgs::msg::GoalInfo::into_rmw_message(std::borrow::Cow::Owned(elem)).into_owned())
          .collect(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
      return_code: msg.return_code,
        goals_canceling: msg.goals_canceling
          .iter()
          .map(|elem| crate::vendor::action_msgs::msg::GoalInfo::into_rmw_message(std::borrow::Cow::Borrowed(elem)).into_owned())
          .collect(),
      })
    }
  }
...
impl rosidl_runtime_rs::Service for CancelGoal {
  ...
  const TYPE_NAME: &'static str = "action_msgs/srv/CancelGoal";
...
pub struct CancelGoal_Response {
    pub return_code: i8,
    pub goals_canceling: rosidl_runtime_rs::Sequence<crate::vendor::action_msgs::msg::rmw::GoalInfo>,
}
