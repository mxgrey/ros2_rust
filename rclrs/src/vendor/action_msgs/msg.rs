...
pub struct GoalStatusArray {
    pub status_list: rosidl_runtime_rs::Sequence<crate::vendor::action_msgs::msg::rmw::GoalStatus>,
}
...
impl Default for GoalInfo {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::vendor::action_msgs::msg::rmw::GoalInfo::default())
  }
}
...
impl Default for GoalStatus {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::vendor::action_msgs::msg::rmw::GoalStatus::default())
  }
}
...
impl rosidl_runtime_rs::Message for GoalStatus {
  ...
  fn into_rmw_message(msg_cow: std::borrow::Cow<'_, Self>) -> std::borrow::Cow<'_, Self::RmwMsg> {
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        goal_info: crate::vendor::action_msgs::msg::GoalInfo::into_rmw_message(std::borrow::Cow::Owned(msg.goal_info)).into_owned(),
        status: msg.status,
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        goal_info: crate::vendor::action_msgs::msg::GoalInfo::into_rmw_message(std::borrow::Cow::Borrowed(&msg.goal_info)).into_owned(),
      status: msg.status,
      })
    }
  }
...
impl Default for GoalStatusArray {
  fn default() -> Self {
    <Self as rosidl_runtime_rs::Message>::from_rmw_message(crate::vendor::action_msgs::msg::rmw::GoalStatusArray::default())
  }
}
    ...
    match msg_cow {
      std::borrow::Cow::Owned(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        status_list: msg.status_list
          .into_iter()
          .map(|elem| crate::vendor::action_msgs::msg::GoalStatus::into_rmw_message(std::borrow::Cow::Owned(elem)).into_owned())
          .collect(),
      }),
      std::borrow::Cow::Borrowed(msg) => std::borrow::Cow::Owned(Self::RmwMsg {
        status_list: msg.status_list
          .iter()
          .map(|elem| crate::vendor::action_msgs::msg::GoalStatus::into_rmw_message(std::borrow::Cow::Borrowed(elem)).into_owned())
          .collect(),
      })
    }
  }
